...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Waste Management </a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="signup.php"><span class="fas fa-sign-out-alt">Sign Up</span></a></li>
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
          ...
          <h2 class="heading">Let's keep our Environment <span class="auto-type1"></span></h2>
...
<br>
   <!-- End Cliens Section -->
    ...
    <section id="why-us" class="why-us section-bg">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <h3>Guidelines implementation <br><strong>must for proper management of medical waste</strong></h3>
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img"
            ...
            style='background-image: url("assets/img/Circle-container-family.png")' data-aos="zoom-in"
            data-aos-delay="150">&nbsp;
    ...
    <div class="row">
      <div class="col-lg-6 d-flex justify-center align-items-center" data-aos="fade-right" data-aos-delay="100">

        <!-- <img src="assets/img/Schemat-circular-economy-EN-08-955x1024.png" class="img-fluid1" alt="" width="450px"> -->
        <!-- <img src="assets/img/only-professional-waste_0.jpg" class="img-fluid" alt=""> -->
      </div>

    <!-- ======= Skills Section ======= -->
   
        <section id="kathmandu" class="why-us section-bg">
          <div class="container-fluid" data-aos="fade-up">
        
    
            <h3>Waste Management <br> in <br> <strong>Kathmandu Metropolitan city</strong></h3>
            <div class="row">
              <div class="content">
                <p>
                  Kathmandu Metropolitan City (KMC) has been facing an increasing problem over the
                  last two decades. Population growth and urbanization has been putting greater stress on
                  the city’s solid waste management system. The city has already exhausted one sanitary
                  landfill site and is currently disposing its solid waste at a second sanitary landfill site.
                  Recycling activities are very limited and informal which puts further stress on the landfill
                  site. The practice of sanitary waste management at the household level also seems to be
                  missing.
              ...
              <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
                ...
                <div class="accordion-list">
                  <ul>
                    <li>
                      <a data-bs-toggle="collapse" class="collapse" data-bs-target="#accordion-list-1"><span>01</span>
                       How Kathmandu Metropolitan waste are managed? <i
                          class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                      <div id="accordion-list-1" class="collapse show" data-bs-parent=".accordion-list">
                        <p>
                          Waste management for Kathmandu is the responsibility of KMC. The Environment
Management Division of KMC manages waste collection and disposal.
Majority of the domestic waste is disposed on the streets or in public waste containers.
Some waste is collected through door-to-door collection. Waste collection is performed
by individual waste collectors on modified cycle-carts and then loaded on to trucks or
tractors. The collected waste is first taken to the Teku Transfer station where waste is
segregated, loaded onto bigger vehicles and sent to Sisdol landfill site.
                        </p>
                    ...
                    <li>
                      <a data-bs-toggle="collapse" data-bs-target="#accordion-list-2" class="collapsed"><span>02</span>
                        Organigations Working for waste management of Kathmandu<i class="bx bx-chevron-down icon-show"></i><i
                          class="bx bx-chevron-up icon-close"></i></a>
                      <div id="accordion-list-2" class="collapse" data-bs-parent=".accordion-list">
                        <p>
                          1.NEPAL POLLUTION CONTROL & ENVIRONMENT MANAGEMENT
                          CENTER <strong>(NEPCEMAC)</strong> <br>
                         2. URBAN ENVIRONMENTAL MANAGEMENT SOCIETY <strong>(UEMS)</strong> <br>
                          3.THE WOMEN’S ENVIRONMENT PRESERVATION COMMITTEE <strong>(WEPCO)</strong>
              ...
              <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img new"
                style='background-image: url("assets/img/Waste_Management_in_KMC__24_Aug_2017.jpg");' data-aos="zoom-in"
        ...
        <section id="skills" class="skills">
          <div class="container" data-aos="fade-up">
            <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
              <h3>Composition <br> and <br> Percentage of Waste Generation</h3>
              <p class="fst-italic">
                Management of Municipal Solid Wastes: A Case Study in Kathmandu Metropolitan City, Nepal
              ...
              <div class="skills-content">
                ...
                <div class="progress">
                  <span class="skill">Plastics <i class="val">10.80%</i></span>
                  <div class="progress-bar-wrap">
                    <div class="progress-bar" role="progressbar" aria-valuenow="10.80" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                </div>

                <div class="progress">
                  <span class="skill">Paper and Glass <i class="val">9.02%</i></span>
                  <div class="progress-bar-wrap">
                    <div class="progress-bar" role="progressbar" aria-valuenow="9.02" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                </div>

                <div class="progress">
                  <span class="skill">Food Waste and Organic waste <i class="val">63.22%</i></span>
                  <div class="progress-bar-wrap">
                    <div class="progress-bar" role="progressbar" aria-valuenow="63.22" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                </div>

                <div class="progress">
                  <span class="skill">Glass<i class="val">5.42%</i></span>
                  <div class="progress-bar-wrap">
                    <div class="progress-bar" role="progressbar" aria-valuenow="5.42" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                </div>

                <div class="progress">
                  <span class="skill">Others<i class="val">11.54%</i></span>
                  <div class="progress-bar-wrap">
                    <div class="progress-bar" role="progressbar" aria-valuenow="11.54" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                </div>
   ...
   <section id="cliens" class="cliens section-bg">
    <div class="container">
      <div class="row" data-aos="zoom-in">
        <h3 class="heading">International Organizations working with waste management</h3>
        <div class="col-lg-3 col-md-4 col-6 d-flex align-items-center justify-content-center">
          <div class="box">
            <img src="./assets/img/ISWA-logo.png" id="hello">
            <div class="box-content">
              <h3 class="title">ISWA</h3>
              <span class="post">To promote and develop sustainable and professional waste management
                worldwide.</span>
              <a href="https://www.iswa.org/about-iswa/?v=8bc2afe7028c" target="_blank">Click here</a>
        ...
        <div class="col-lg-3 col-md-4 col-6 d-flex align-items-center justify-content-center">
          <div class="box">
            <img src="./assets/img/download.png" id="hello">
            <div class="box-content">
              <h3 class="title">NSWAI</h3>
              <span class="post">To promote for different waste streams by creating a sustainable VALUE CHAIN.</span>
              <a href="https://www.nswai.org/about.php" target="_blank">Click here</a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-6 d-flex align-items-center justify-content-center">
          <div class="box">
            <img src="./assets/img/wasteaid-logo (1).png" id="hello">
            <div class="box-content">
              <h3 class="title">wasteaid</h3>
              <span class="post">To work with communities and policy-makers in lower and middle-income countries.</span>
              <a href="https://www.wasteaid.org/about.php" target="_blank">Click here</a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-6 d-flex align-items-center justify-content-center">
          <div class="box">
            <img src="./assets/img/swana2cweb.jpg" id="hello">
            <div class="box-content">
              <h3 class="title">SWANA</h3>
              <span class="post">To advance from solid waste management to resource management </span>
              <a href="https://www.swana.org/about.php" target="_blank">Click here</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer id="footer">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 footer-contact">
              <h3><img src="assets/img/hero-img.png" style="width:80px;height:60px;"></h3>
              <p>
               Kathmandu <br>
               
                Nepal <br>
                <strong>Phone:</strong>+977 14231481<br>
                <strong>Email:</strong>
                mayor@kathmandu.gov.np <br>
                ceo@kathmandu.gov.np <br>
                 <a href="https://kathmandu.gov.np/?lang=en" target="_blank">kathmandu.gov.np</a>
              </p>
            </div>
      ...
      <div class="container footer-bottom clearfix">
        ...
        <div class="credits">
          Designed by <a href="">Aasis Shrestha </a> and <a href="">MD Gyasuddin Mansuri </a>
        </div>
      </div>
    </footer><!-- End Footer -->
    ...
    <script>
      var typed = new Typed('.auto-type', {
        ...
        strings: ["Welcome to Waste management  website."],
        typeSpeed: 100,
      ...
      var typed = new Typed('.auto-type1', {
        ...
        strings: ["Healthy", "Neat and clean"],
        typeSpeed: 100,
        backSpeed: 100,
        loop: true
